...
public class DeliveryTypesAdapter extends RecyclerView.Adapter<DeliveryTypesAdapter.ViewHolder> {
    ...
    private List<ModesTypesModel> model;

    private AdapterClickListenerCallback itemClick;

    public DeliveryTypesAdapter(Context context, List<ModesTypesModel> model, AdapterClickListenerCallback click) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ModesTypesModel model = this.model.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final int pos, final ModesTypesModel item, final AdapterClickListenerCallback onClickListner){
