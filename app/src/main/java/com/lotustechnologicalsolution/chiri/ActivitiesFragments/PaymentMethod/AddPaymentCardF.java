...
public class AddPaymentCardF extends RootFragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.back_icon:
                DoYouAgreeFragment fragment = new DoYouAgreeFragment();
                FragmentTransaction transaction =getActivity().getSupportFragmentManager().beginTransaction();
                transaction.addToBackStack("DoYouAgree");
                transaction.setCustomAnimations(R.anim.in_from_right, R.anim.out_to_left, R.anim.in_from_left, R.anim.out_to_right);
                transaction.replace(R.id.fl_id, fragment,"DoYouAgree").commit();;
                break;
