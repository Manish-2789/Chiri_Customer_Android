...
import com.lotustechnologicalsolution.DoYouAgreeFragment;
import com.lotustechnologicalsolution.TermsAndConditionsFragment;
import com.lotustechnologicalsolution.WhatIsYourEmail;
...
//            sendobj.put("dob", model.getDateOfBirthday());
            sendobj.put("username", (etUserName.getText().toString() + etUserNameFirst.getText().toString()));
