...
import com.lotustechnologicalsolution.chiri.ActivitiesFragments.MainHome.SearchLocationA;
...
public class AddLocationUpdateAddressSelectionF extends RootFragment implements View.OnClickListener,
    ...
    private void METHOD_selectLocation(String title,String query) {
        /*Fragment f = new SearchLocationA(query,title, null, new FragmentClickCallback() {
            @Override
