package com.lotustechnologicalsolution.chiri.BottomSheetDialogsFragments;
...
import com.lotustechnologicalsolution.chiri.RecyclerViewAdapters.DeliveryTypesAdapter;
...
public class DeliveryTypesBottomSheet extends BottomSheetDialogFragment {
    ...
    private List<ModesTypesModel> list = new ArrayList<>();
    public static String id;
    FragmentClickCallback callback;


    public DeliveryTypesBottomSheet(List<ModesTypesModel> list, String id,
                                    FragmentClickCallback callback){
        this.list.clear();
        this.list = list;
        this.id = id;
